...
Registry.prototype._getTextureURLs = function(names) {
  ...
  if (Array.isArray(names)) {
    ...
    console.warn('registry _getTextureURLs invald name object (try a string):'+name);
    throw new Error('registry _getTextureURLs invald name object (try a string):'+name);
  }
