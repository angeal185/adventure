...
function Control(state, opts) {
  ...
  this.max_speed = opts.maxSpeed;
  this.jump_max_speed = opts.jumpMaxSpeed;
  this.jump_max_timer = opts.jumpTimer;
  this.jump_speed = opts.jumpSpeed;
  this.jump_timer = this.jump_timer_max;
  this.jumping = false;
  this.acceleration = opts.accelerationCurve || this.acceleration;

  this.fire_rate = opts.fireRate;
  this.needs_discrete_fire = opts.discreteFire;
  this.onfire = opts.onfire || this.onfire;
  this.firing = 0;

  this.x_rotation_per_ms = opts.rotationXMax;
  this.y_rotation_per_ms = opts.rotationYMax;
  this.z_rotation_per_ms = opts.rotationZMax;

  this.x_rotation_clamp = opts.rotationXClamp;
  this.y_rotation_clamp = opts.rotationYClamp;
  this.z_rotation_clamp = opts.rotationZClamp;
  ...
  this.accel_max_timer = opts.accelTimer;
